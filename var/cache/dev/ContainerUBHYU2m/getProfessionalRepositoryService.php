...
// Returns the private 'App\Repository\ProfessionalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ProfessionalRepository.php';

return $this->privates['App\Repository\ProfessionalRepository'] = new \App\Repository\ProfessionalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
