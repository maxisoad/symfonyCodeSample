...
// Returns the private 'App\Repository\SpecialtyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\SpecialtyRepository.php';

return $this->privates['App\Repository\SpecialtyRepository'] = new \App\Repository\SpecialtyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
